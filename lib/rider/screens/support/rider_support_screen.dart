...
/// Rider support tickets list screen.
...
class _RiderSupportScreenState extends State<RiderSupportScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => RiderNewTicketScreen(
      ...
      body: StreamBuilder<List<SupportTicketModel>>(
        stream: SupportTicketService().streamUserTickets(rider.riderId),
  ...
  void _openDetail(SupportTicketModel ticket) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => RiderTicketDetailScreen(
          ticket: ticket,
          riderId: rider.riderId,
          riderName: rider.name,
        ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    statusLabel,
                    style: TextStyle(
                        fontSize: 11, fontFamily: 'Bold', color: statusColor),
                  ),
                ),
              ],
            ),
